...
class DiamondService {
  ...
  Future<bool> grantSignUpBonus(String userId) async {
    ...
    return await _firestore.runTransaction<bool>((txn) async {
      ...
      await _logReward(
        userId,
        DiamondRewardType.signUpBonus,
        DiamondRewards.signUpBonus,
      );
      return true;
    });
  }
  ...
  Future<bool> claimDailyLogin(String userId) async {
    ...
    await _addDiamonds(
      userId,
      DiamondRewards.dailyLogin,
      DiamondRewardType.dailyLogin,
    );
  ...
  Future<void> grantGameComplete(String userId) async {
    await _addDiamonds(
      userId,
      DiamondRewards.gameComplete,
      DiamondRewardType.gameComplete,
    );
  }
  ...
  Future<void> grantReferralBonus(String referrerId, String newUserId) async {
    ...
    await _addDiamonds(
      referrerId,
      DiamondRewards.referralBonus,
      DiamondRewardType.referral,
    );
  ...
  Future<void> grantWeeklyBonus(String userId) async {
    await _addDiamonds(
      userId,
      DiamondRewards.weeklyBonus,
      DiamondRewardType.weeklyBonus,
    );
  }
  ...
  Future<void> grantAdReward(String userId) async {
    await _addDiamonds(
      userId,
      DiamondRewards.watchAd,
      DiamondRewardType.watchAd,
    );
  }
  ...
  Future<bool> spend(String userId, int amount, String reason) async {
    ...
    try {
      return await _firestore.runTransaction<bool>((txn) async {
        ...
        txn.update(userRef, {'diamonds': currentBalance - amount});
  ...
  Future<void> _addDiamonds(
    String userId,
    int amount,
    DiamondRewardType type,
  ) async {
