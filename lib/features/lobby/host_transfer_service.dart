...
class HostTransferResult {
  ...
  factory HostTransferResult.roomNotFound() => 
      HostTransferResult._(
        status: HostTransferStatus.roomNotFound, 
        message: 'Room not found',
      );
  
  factory HostTransferResult.noEligibleHost() => 
      HostTransferResult._(
        status: HostTransferStatus.noEligibleHost, 
        message: 'No eligible host found',
      );
  
  factory HostTransferResult.roomAbandoned() => 
      HostTransferResult._(
...
class HostTransferService {
  ...
  Future<HostTransferResult> transferHost(String roomId, String currentHostId) async {
  ...
  Future<HostTransferResult> handleHostLeave(String roomId, String hostId) async {
  ...
  Future<void> _notifyHostChange(String roomId, String newHostId, String newHostName) async {
