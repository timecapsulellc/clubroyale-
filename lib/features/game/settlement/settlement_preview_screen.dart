...
class SettlementPreviewScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SettlementPreviewScreen> createState() => _SettlementPreviewScreenState();
}

class _SettlementPreviewScreenState extends ConsumerState<SettlementPreviewScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Winner announcement
              if (winner != null)
                _WinnerCard(winner: winner, gameType: settlementData.gameType)
              ...
              _SettlementBreakdown(data: settlementData)
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _StatBadge(label: 'Won', value: '+${winner.winnings}💎', isGold: true),
            ],
          ),
...
class _StatBadge extends StatelessWidget {
  ...
  const _StatBadge({required this.label, required this.value, this.isGold = false});
        ...
        children: [
          ...
          ...losers.expand((loser) {
            return winners.where((w) => w.netResult > 0).map((winner) {
              ...
              final transfer = (loser.netResult.abs() * winner.netResult / totalWinnings).round();
