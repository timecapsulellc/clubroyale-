  ...
  Widget _buildGameBody(GameRoom game, TestGameService service) {
    ...
    return Column(
      children: [
        ...
        // Current trick
        Expanded(child: _buildTrickArea(game, humanPlayer.id, phase)),
      ...
      return Container(
        ...
        child: Column(
          children: [
            const Text(
              '🎉 Game Complete!',
              style: TextStyle(color: CasinoColors.gold, fontSize: 24),
            ),
            const SizedBox(height: 16),
            ElevatedButton(
              style: ElevatedButton.styleFrom(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: PlayingCardWidget(
                    ...
                    width: 70,
                    height: 98,
                    onTap: canPlay ? () => service.playCard(myId, card) : () {},
                  ),
                );
              },
            ),
