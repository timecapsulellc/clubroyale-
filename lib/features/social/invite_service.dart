...
class InviteValidation {
  ...
  factory InviteValidation.valid({
  ...
  factory InviteValidation.expired() => InviteValidation._(
    status: InviteStatus.expired,
    error: 'Invite has expired',
  );

  factory InviteValidation.roomNotFound() => InviteValidation._(
    status: InviteStatus.roomNotFound,
  ...
  factory InviteValidation.gameStarted() => InviteValidation._(
    status: InviteStatus.gameStarted,
