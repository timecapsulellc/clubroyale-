...
class TeenPattiBotController {
  ...
  Future<void> _processBotTurn(TeenPattiGameState state, String botId) async {
    ...
    if (activeCount == 2 && player.status == PlayerStatus.seen && hand.length == 3) {
  ...
  PlayerStatus _parseStatus(String status) {
    switch (status) {
      case 'blind': return PlayerStatus.blind;
      case 'seen': return PlayerStatus.seen;
      case 'folded': return PlayerStatus.folded;
      default: return PlayerStatus.blind;
    }
  }
