  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: hasMarriage ? Colors.purple.withOpacity(0.8) : Colors.black.withOpacity(0.6),
        ...
        boxShadow: hasMarriage ? [
          BoxShadow(color: Colors.purpleAccent.withOpacity(0.4), blurRadius: 10, spreadRadius: 2)
        ] : [],
      ),
      child: Row(
        ...
        children: [
          ...
          ).animate(key: ValueKey(points)).scale(duration: 300.ms, curve: Curves.easeOutBack),
