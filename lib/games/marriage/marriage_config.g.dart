...
_MarriageGameConfig _$MarriageGameConfigFromJson(Map<String, dynamic> json) =>
    _MarriageGameConfig(
      ...
      tunnelDisplayBonusValue:
          (json['tunnelDisplayBonusValue'] as num?)?.toInt() ?? 5,
      marriageBonus: json['marriageBonus'] as bool? ?? true,
      marriageBonusValue: (json['marriageBonusValue'] as num?)?.toInt() ?? 10,
      eightDubleeWinEnabled: json['eightDubleeWinEnabled'] as bool? ?? true,
      eightDubleeWinBonus: (json['eightDubleeWinBonus'] as num?)?.toInt() ?? 5,
      ...
      tunnelPachaunu: json['tunnelPachaunu'] as bool? ?? false,
...
Map<String, dynamic> _$MarriageGameConfigToJson(_MarriageGameConfig instance) =>
    <String, dynamic>{
      ...
      'tunnelDisplayBonusValue': instance.tunnelDisplayBonusValue,
      'marriageBonus': instance.marriageBonus,
      'marriageBonusValue': instance.marriageBonusValue,
      'eightDubleeWinEnabled': instance.eightDubleeWinEnabled,
      'eightDubleeWinBonus': instance.eightDubleeWinBonus,
      ...
      'tunnelPachaunu': instance.tunnelPachaunu,
