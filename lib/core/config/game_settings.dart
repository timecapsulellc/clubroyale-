...
final gameSettingsProvider = NotifierProvider<GameSettingsNotifier, GameSettingsState>(() {
...
class GameSettingsNotifier extends Notifier<GameSettingsState> {
  ...
  Future<void> _init() async {
    ...
    if (savedRegionName != null) {
        initialRegion = savedRegionName == 'southAsia' ? GameRegion.southAsia : GameRegion.global;
    } else {
        // First launch - auto-detect
        initialRegion = GameSettings.detectFromLocale(PlatformDispatcher.instance.locale);
