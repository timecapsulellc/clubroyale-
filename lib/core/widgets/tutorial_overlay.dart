...
class _TutorialOverlayState extends State<TutorialOverlay> {
      ...
      children: [
        ...
        if (targetRect != null)
          Positioned(
            ...
            .boxShadow(begin: BoxShadow(color: CasinoColors.gold.withOpacity(0.5), blurRadius: 10), end: BoxShadow(color: CasinoColors.gold.withOpacity(0.0), blurRadius: 20)),
          ),
  ...
  Widget _buildTooltip(TutorialStep step, Rect? targetRect, Size screenSize) {
    ...
    return Positioned(
      ...
      left: left,
      right: right,
      child: Material( // Material required for buttons
