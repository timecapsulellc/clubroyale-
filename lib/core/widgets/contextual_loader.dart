...
class ContextualLoader extends StatelessWidget {
  ...
  factory ContextualLoader.settingUpGame() =>
      const ContextualLoader(message: 'Setting up game...', icon: Icons.casino);

  factory ContextualLoader.shufflingCards() =>
      const ContextualLoader(message: 'Shuffling cards...', icon: Icons.style);
...
class EmptyStateWidget extends StatelessWidget {
  ...
  factory EmptyStateWidget.noGames({VoidCallback? onCreate}) =>
      EmptyStateWidget(
  ...
  factory EmptyStateWidget.noFriends({VoidCallback? onFindFriends}) =>
      EmptyStateWidget(
        icon: Icons.people_outline,
